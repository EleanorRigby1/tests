...
void ProtocolGame::parsePacket(NetworkMessage& msg)
{
	...
	switch (recvbyte) {
		...
		case 0x72: addGameTimedTaskWithPlayer(player->getName(), DISPATCHER_TASK_EXPIRATION, &Game::playerTurn, player->getID(), DIRECTION_WEST); break;		case 0x78: parseThrow(msg); break;
		...
		case 0xBE: addGameTaskWithPlayer(player->getName(), &Game::playerCancelAttackAndFollow, player->getID()); break;		case 0xC9: /* update tile */ break;
